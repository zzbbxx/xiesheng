    ...
    <form method='post' id='ajaxForm' class="w-p50">
      <table class='table table-form'>
        <tr>
          ...
          <td><?php echo html::select('companyID', $lang->childrenCompany, '', "class='form-control w-300px'");?></td>
        </tr>
        <tr>
          <th><?php echo $lang->invoice->type;?></th>
          <td><?php echo html::select('type', $lang->invoice->typeList, '', "class='form-control w-300px'");?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><?php echo html::input('number', '', "class='form-control w-300px'");?></td>
        </tr>
        <tr>
          <th><?php echo $lang->invoice->customer;?></th>
          <td><?php echo html::select('customerID', $customerList, '', "class='form-control w-300px'");?></td>
        </tr>
        <tr>
          <th><?php echo $lang->invoice->remark;?></th>
          <td><?php echo html::textarea('remark', '', "rows='6' class='form-control w-300px'");?></td>
        </tr>
        <tr>
