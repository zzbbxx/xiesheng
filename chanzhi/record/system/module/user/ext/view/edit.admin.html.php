...
<?php 
$driverList = array('0' => '') + $this->loadModel('driver')->getDriversByType('name');
?>
  ...
  <div class='panel-body'>
    <form method='post' id='editForm' class='form form-inline' data-checkfingerprint='1'>
      <table class='table table-form'>
        ...
        <tr>
          <th><?php echo $lang->driver->common;?></th>
          <td><?php echo html::select('driverID', $driverList, $user->driverID, "class='form-control'")?></td><td></td>
        </tr>  
        <tr>
