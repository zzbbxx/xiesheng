...
<div class='panel'>
  <div class='panel-heading'>
    <strong><i class="icon-plus"></i> <?php echo $lang->record->create;?></strong>
  </div>
    ...
    <form method='post' id='ajaxForm' class="w-p50">
      <table class='table table-form'>
        <tr>
          ...
          <?php else:?>
            <?php echo html::select("customerID", $customerList, '', "class='form-control w-200px'");?>
          <?php endif;?>
          </td>
        </tr>
        <tr>
          ...
          <?php else:?>
            <?php echo html::select("driverID", $driverList, '', "class='form-control w-200px'");?>
          <?php endif;?>
          </td>
        </tr>
        <tr>
          ...
          <?php else:?>
            <?php echo html::select("carID", $carList, '', "class='form-control w-200px'");?>
          <?php endif;?>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="input-append date">
              <?php echo html::input('beginDate', date('Y-m-d H:i'), "class='form-control form-date'");?>
        ...
        <tr>
          ...
          <td>
            <div class="input-append date">
              <?php echo html::input('finishDate', date('Y-m-d H:i'), "class='form-control form-date'");?>
              <span class='add-on'><button class="btn btn-default" type="button"><i class="icon-calendar"></i></button></span>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="input-append date">
              <?php echo html::textarea('route', '', "class='form-control' rows=6");?>
            </div>
          </td>
        </tr>
        <tr>
          ...
          <td>
            <div class="input-append date">
              <?php echo html::textarea('remark', '', "class='form-control' rows=6");?>
            </div>
          </td>
        </tr>
        <tr>
